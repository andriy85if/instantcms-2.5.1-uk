...
(143, 'content', 'pages.all', 'LANG_WP_CONTENT_ALL_PAGES', 'Сторінки', NULL, 'pages\npages-*\npages/*', NULL),
(144, 'content', 'pages.list', 'LANG_WP_CONTENT_LIST', 'Сторінки', NULL, 'pages\npages-*\npages/*', 'pages/*.html\npages/add\npages/edit/*'),
(145, 'content', 'pages.item', 'LANG_WP_CONTENT_ITEM', 'Сторінки', NULL, 'pages/*.html', NULL),
(146, 'content', 'pages.edit', 'LANG_WP_CONTENT_ITEM_EDIT', 'Сторінки', NULL, 'pages/add\npages/edit/*', NULL),
